 ...
 */
final class Version20231122100322 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, photo_id INT NOT NULL, commentaire_id INT DEFAULT NULL, description VARCHAR(255) NOT NULL, date_commentaire DATETIME NOT NULL, likes_count INT NOT NULL, dislikes_count INT NOT NULL, INDEX IDX_67F068BCA76ED395 (user_id), INDEX IDX_67F068BC7E9E4C8C (photo_id), UNIQUE INDEX UNIQ_67F068BCBA9CD190 (commentaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE likes_commentaire (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, commentaire_id INT NOT NULL, like_type TINYINT(1) DEFAULT NULL, INDEX IDX_1A3A4385A76ED395 (user_id), INDEX IDX_1A3A4385BA9CD190 (commentaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE likes_photo (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, photo_id INT NOT NULL, like_type TINYINT(1) DEFAULT NULL, INDEX IDX_A84B289EA76ED395 (user_id), INDEX IDX_A84B289E7E9E4C8C (photo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE photo (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, image VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, date_poste DATETIME NOT NULL, likes_count INT NOT NULL, dislikes_count INT NOT NULL, is_locked TINYINT(1) NOT NULL, INDEX IDX_14B78418A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
